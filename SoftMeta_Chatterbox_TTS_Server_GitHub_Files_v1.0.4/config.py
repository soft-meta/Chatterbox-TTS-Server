...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "avatar": {
        "python": "",
        "longcat_dir": "/content/LongCat-Video",
        "longcat_models": "/content/longcat_models",
        "default_engine": "auto",
...
def load_config() -> dict[str, Any]:
    ...
    if os.getenv("SOFTMETA_LONGCAT_DIR"):
        config["avatar"]["longcat_dir"] = os.environ["SOFTMETA_LONGCAT_DIR"]
    if os.getenv("SOFTMETA_LONGCAT_MODELS"):
        config["avatar"]["longcat_models"] = os.environ["SOFTMETA_LONGCAT_MODELS"]
    return config
