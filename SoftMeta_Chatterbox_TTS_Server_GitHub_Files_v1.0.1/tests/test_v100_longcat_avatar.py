...
class LongCatAvatarRegressionTests(unittest.TestCase):
    ...
    def test_installer_is_pinned_selective_and_safe(self):
        ...
        self.assertIn("d3cfdd023b970061e6338c6e5094f7b12e804873", installer)
        ...
        self.assertIn("grep -Ev '^libsndfile1", installer)
        self.assertIn(".softmeta_longcat_avatar_v15_v101", installer)
    ...
    def test_colab_uses_longcat_only_when_enabled(self):
        notebook_path = ROOT / "colab/SoftMeta_Chatterbox_TTS_Colab_v1.0.1.ipynb"
