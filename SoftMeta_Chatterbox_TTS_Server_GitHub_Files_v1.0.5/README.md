...
## v1.0.5: LongCat realistic avatar engine

- Pins the complete verified Avatar 1.5 model revision containing all four INT8
  safetensors shards. The previous upstream revision was an incomplete upload
  with only shard 1, so retries could never download shards 2 through 4.
...
Open `colab/SoftMeta_Chatterbox_TTS_Colab_v1.0.5.ipynb`, select an **A100 GPU**,
