...
def count_words(text: str) -> int:
    # Native Turbo expression tags are control tokens, not spoken words. Keeping
    # them out of word counts makes the UI, chunk sizing and progress estimates
    # stay aligned after Auto Emotion inserts visible tags into the script.
    return len(_WORD.findall(_SAFE_TURBO_TAG.sub("", text)))
