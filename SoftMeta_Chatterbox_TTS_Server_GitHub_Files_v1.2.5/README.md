...
- Auto Emotion never auto-inserts laugh, chuckle, angry, crying or sarcastic cues in Motivational Speech
...
Open `colab/SoftMeta_Chatterbox_TTS_Colab_v1.2.5.ipynb` and run all cells.
