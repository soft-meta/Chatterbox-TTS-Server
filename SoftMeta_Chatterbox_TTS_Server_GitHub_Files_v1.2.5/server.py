...
MODELS = [
    ...
    },
    {
        ...
        "badge": "Turbo",
        "description": "Low-latency English narration and voice cloning with lower compute and VRAM.",
    },
    {
        "id": "chatterbox-nano",
...
PRESETS = [
    {
        ...
        "description": "Calm senior-advisor narration with sparse, serious Auto Emotion for Turbo; naturally slow and easy to follow for older audiences.",
        "language": "en",
        "temperature": 0.8,
        "exaggeration": 0.65,
        "cfg_weight": 0.35,
...
def analyze_emotion(request: EmotionAnalyzeRequest) -> dict[str, Any]:
    """Preview the conservative Turbo emotion direction used at generation time."""
    analysis = analyze_serious_senior_advisor(request.text)
    return analysis.public_summary(include_text=False)
