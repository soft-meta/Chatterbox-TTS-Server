...
MODELS = [
    {
        ...
        "badge": "Original",
        "description": "Expressive English narration and voice cloning with the same Professional Speech Pipeline as Turbo when Motivational Speech is selected.",
    },
    {
        "id": "chatterbox-turbo",
        "name": "Chatterbox Turbo (English)",
        "badge": "Turbo",
        "description": "Low-latency English narration and voice cloning with the unified Professional Speech Pipeline.",
    },
    {
        "id": "chatterbox-nano",
