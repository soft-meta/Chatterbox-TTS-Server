...
class GenerationOptions(BaseModel):
    ...
    exaggeration: float = Field(0.0, ge=0.0, le=2.0)
    cfg_weight: float = Field(0.0, ge=0.0, le=1.0)
    ...
    sentence_end_pause_ms: int = Field(280, ge=0, le=1000)
