...
def test_colab_is_small_and_has_no_embedded_patch() -> None:
    notebook_path = ROOT / "colab" / "SoftMeta_Chatterbox_TTS_Colab_v0.9.7.ipynb"
...
def test_optional_installers_are_idempotent() -> None:
    ...
    assert ".softmeta_moss_runtime_v097" in moss
    assert ".softmeta_ditto_pytorch_v097" in avatar
