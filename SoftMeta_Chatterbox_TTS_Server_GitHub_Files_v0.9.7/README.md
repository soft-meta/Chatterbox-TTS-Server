...
## v0.9.7: reliable fast-start Colab build

- Installs MediaPipe and Einops, both required by Ditto's PyTorch import tree.
- Uses NumPy 1.26.4 so MediaPipe and the remaining Ditto scientific stack resolve together.
- Verifies the complete Ditto import path before reporting that the Avatar engine is ready.
...
Open `colab/SoftMeta_Chatterbox_TTS_Colab_v0.9.7.ipynb`, select an **A100 GPU**
