...
READY_MARKER="$MODEL_ROOT/.softmeta_longcat_avatar_v15_v103"
...
runtime_ok() {
  ...
  [[ -f "$LONGCAT_DIR/.softmeta_longcat_runtime_patch_v103" ]] || return 1
...
required = [
    ...
    repo / ".softmeta_longcat_runtime_patch_v103",
