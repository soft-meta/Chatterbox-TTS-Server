...
## v1.6.10 Turbo Creator Controls
...
v1.6.10 keeps the clean Chatterbox Turbo generation architecture from v1.6.0 and restores the creator controls requested from v1.2.1. No Auto Emotion, ASR/QC, speaker verification, retry/rescue, pronunciation rewrite, prosody stack, EQ/compression or advanced mastering has been reintroduced.
...
The v1.6.10 Colab notebook keeps the server alive under the existing supervisor and retains the manual Disconnect Colab control.
